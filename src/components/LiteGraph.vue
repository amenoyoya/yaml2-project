...
export default {
  ...
  mounted() {
    ...
    createNode(litegraph.LiteGraph, "modV/visualInput", {
      title: "Visual Input",
      outputs: {
    ...
    createNode(litegraph.LiteGraph, "modV/visualOutput", {
      title: "Visual Output",
      inputs: {
        context: "renderContext"
      },
    ...
    createNode(litegraph.LiteGraph, "modV/contextSplitter", {
    ...
    createNode(litegraph.LiteGraph, "modV/visualMonitor", {
    ...
    createNode(litegraph.LiteGraph, "modV/contextJoiner", {
    ...
    createNode(litegraph.LiteGraph, "modV/modules/circle", {
      title: "Circle",
      inputs: {
        context: "renderContext",
        circleSize: "number"
    ...
    createNode(litegraph.LiteGraph, "modV/modules/squishy", {
      title: "Squishy",
      inputs: {
        context: "renderContext"
      },
    ...
    createNode(litegraph.LiteGraph, "modV/modules/blockColor", {
      title: "Block Colour",
      inputs: {
        context: "renderContext",
        r: "number",
